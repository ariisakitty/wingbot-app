...
static const _Server2Robot_type_support_symbol_names_t _Server2Robot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bridge_interface, msg, Server2Robot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bridge_interface, msg, Server2Robot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bridge_interface, msg, Server2Robot)() {
  return &::bridge_interface::msg::rosidl_typesupport_c::Server2Robot_message_type_support_handle;
}
